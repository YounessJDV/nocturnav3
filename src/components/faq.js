        ...
        <div className="max-w-2xl sm:mx-auto lg:max-w-3xl">
          ...
          <div className="space-y-4">
            <Item title="Comment me lancer ?">
              Pour vous lancer dans la création de votre site web, contactez-nous tout simplement par téléphone au 07 81 90 51 92 ou par mail <Link to="/contact" className="text-[#45008B]">ici</Link>.
            </Item>
